...
export default function Contact() {
  ...
  return (
    <main className='h-[83vh] flex justify-center items-center'>
      <div className="max-w-xl mx-auto p-6 bg-white rounded-md shadow-md md:w-2/3 lg:w-1/2 overflow-y-auto"> {/* Se agregó la clase overflow-y-auto */}
        ...
        <form className="space-y-4" onSubmit={handleSubmit}>
          ...
          <div>
            ...
            <textarea
              ...
              onChange={handleChange}
              rows="5" // Agregar límite de altura para el textarea
              style={{ resize: 'none' }} // Evitar el redimensionamiento del textarea
            ></textarea>
